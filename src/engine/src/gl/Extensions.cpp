...
ENGINE_EXPORT void GlExtensions::Initialize() {
    ...
    hardcodedExtensions_[ARB_invalidate_subdata]          = supports("GL_ARB_invalidate_subdata", glInvalidateFramebuffer != nullptr);
    hardcodedExtensions_[ARB_framebuffer_sRGB]            = supports("GL_ARB_framebuffer_sRGB", OK);
    hardcodedExtensions_[ARB_shading_language_include]    = supports("GL_ARB_shading_language_include", glNamedStringARB != nullptr);
    ...
    hardcodedExtensions_[ARB_texture_storage_multisample] = supports("GL_ARB_texture_storage_multisample", glTexStorage2DMultisample != nullptr);
